...
f3 = p3 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs Hepatitis.B") + stat_smooth()
f3
```
...
f4 = p4 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs Measles") + stat_smooth()
f4
```
...
f6 = p6 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs Polio") + stat_smooth()
f6
```
...
f8 = p8 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs Diphtheria") + stat_smooth()
f8
```
...
f9 = p9 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs HIV/AIDS") + stat_smooth()
f9
```
...
f11 = p11 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs Schooling") + stat_smooth()
f11
...
f12 = p12 + geom_point(aes(color=Status)) + ggtitle("Life Expectancy vs Alcohol") + stat_smooth()
f12
...
```{r}
Data=data
boxplot(Data$Adult.Mortality,main="Adult Mortality", col=2)
boxplot(Data$infant.deaths, main="Infant deaths", col=2)
boxplot(Data$Alcohol, main="Alcohol", col=2)
boxplot(Data$Hepatitis.B, main="Hepatitis.B", col=2)
boxplot(Data$Measles, main ="Measles", col=2)
boxplot(Data$BMI, main="BMI", col=2)
boxplot(Data$under.five.deaths,main = "Under Five deaths", col=2)
boxplot(Data$Polio, main="Polio", col=2)
boxplot(Data$Diphtheria, main="Diphtheria", col=2)
boxplot(Data$HIV.AIDS, main="HIV/AIDS", col=2)
boxplot(Data$percentage.expenditure, main="percentage expenditure", col=2)
boxplot(Data$Total.expenditure, main="Total Expenditure", col=2)
boxplot(Data$Income.composition.of.resources,main = "Income Composition of resources", col=2)
boxplot(Data$Schooling, main="Schooling", col=2)
boxplot(Data$thinness.5.9.years, main="Thinness of 5-9 years", col=2)
boxplot(Data$thinness..1.19.years, main="Thinness of 1-19 years", col=2)
